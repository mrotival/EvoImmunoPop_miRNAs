...
all_CARSCORES = list()
for (cond in 1:5){
  all_CARSCORES[[cond]] = fread(paste(EVO_IMMUNO_POP, "/Maxime/miRNA_V2/data/13.correlation_transcription_miRNA/variance_explained_by_miRNA_CARScore/variance_explained_by_miRNA_CARScore_",cond,".tsv", sep=""))
}
...
colnames_to_delete = c(paste("miRNA_variance", 7:10, sep="_"),
                        paste("miRNA", 7:10, sep="_"),
                        paste("miRNA_carscore_sign", 7:10, sep="_"))
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "transcription_variation_explaind_by_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "transcription_variation_explaind_by_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "transcription_variation_explaind_by_negative_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "transcription_variation_explaind_by_negative_and_binding_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "percent_genes_regulated_by_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "percent_genes_regulated_by_negative_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/13.correlation_transcription_miRNA/", "percent_genes_regulated_by_negative_binding_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
