...
def get_data_frame_basis():
    infile = "../results/miRNA_binding_sites_on_protein_coding_3primeUTR.txt"
    miRNAs = []
    transcripts = []
    miRNABS_start_pos = []
    miRNABS_length = []
    ...
    interaction_dictionnary["miRNA"] = miRNAs
    interaction_dictionnary["transcripts"] = transcripts
    interaction_dictionnary["miRNABS_start_pos"] = miRNABS_start_pos
    interaction_dictionnary["miRNABS_length"] = miRNABS_length
...
def main():
    ...
    interaction_df.to_csv(
        "../results/miRNA_binding_sites_on_protein_coding_3primeUTR_simplified.tsv",
        sep="\t",
        index=False,
    )
