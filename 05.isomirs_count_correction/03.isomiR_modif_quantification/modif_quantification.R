...
cat_var_File=sprintf("%s/Maxime/miRNA_V2/data/03.total_miRNA_expression_alignment_and_count_correction/covariates/all_categorical_variables.tsv", EVO_IMMUNO_POP)
cont_var_File=sprintf("%s/Maxime/miRNA_V2/data/03.total_miRNA_expression_alignment_and_count_correction/covariates/all_continuous_variables.tsv", EVO_IMMUNO_POP)
...
for (i in miRNA_modifs){
    ...
    fwrite(as.data.frame(Pct_modif_permiRNA[[i]]),file=sprintf('%s/Maxime/miRNA_V2/data/05.isomirs_count_correction/isomiR_modifs/%s_allmiRNAs.txt',EVO_IMMUNO_POP,i),sep='\t')
...
fwrite(RES_pop,file=sprintf('%s/Maxime/miRNA_V2/data/05.isomirs_count_correction/isomiR_modifs/population_differences.txt',EVO_IMMUNO_POP),sep='\t')
fwrite(RES_cond,file=sprintf('%s/Maxime/miRNA_V2/data/05.isomirs_count_correction/isomiR_modifs/stimulation_differences.txt',EVO_IMMUNO_POP),sep='\t')
fwrite(RES_arm,file=sprintf('%s/Maxime/miRNA_V2/data/05.isomirs_count_correction/isomiR_modifs/arm_differences.txt',EVO_IMMUNO_POP),sep='\t')
