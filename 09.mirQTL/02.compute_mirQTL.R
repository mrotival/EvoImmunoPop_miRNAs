...
if (permutation == 0){ #Classic run
  ...
  shuffled_colnames = c("miRNA_ID", sample(colnames_to_shuffle))
  ...
  expression_file_name = paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/09.mirQTL/files_for_computation/miRNA_coordinate", chromosome,"_",condition, "_", permutation,".tsv", sep="")
...
if(permutation!=0){
  ...
  write.table(me$cis$eqtls, paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/09.mirQTL/cis_mirQTL/permutations/eqtls", chromosome,"_",condition, "_", permutation,"_matrixeQTL_output.tsv", sep=""), quote = F, row.names = F, sep="\t")
  write.table(me$trans$eqtls, paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/09.mirQTL/trans_mirQTL/permutations/eqtls", chromosome,"_",condition, "_", permutation,"_matrixeQTL_output.tsv", sep=""), quote = F, row.names = F, sep="\t")
}else{
  write.table(me$cis$eqtls, paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/09.mirQTL/cis_mirQTL/eqtls", chromosome,"_",condition, "_", permutation,"_matrixeQTL_output.tsv", sep=""), quote = F, row.names = F, sep="\t")
  write.table(me$trans$eqtls, paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/09.mirQTL/trans_mirQTL/eqtls", chromosome,"_",condition, "_", permutation,"_matrixeQTL_output.tsv", sep=""), quote = F, row.names = F, sep="\t")
}
