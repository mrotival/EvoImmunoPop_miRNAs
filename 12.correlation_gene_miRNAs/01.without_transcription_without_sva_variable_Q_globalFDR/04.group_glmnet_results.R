# sbatch -p geh --qos=geh -J noTR_agg -o noTR_agg.log --mem=200G /pasteur/homes/mrotival/01_scripts/R_runner_tars.sh /pasteur/projets/policy01/evo_immuno_pop/Maxime/miRNA_V2/scripts/12.correlation_gene_miRNAs/without_transcription_without_sva_variable_Q_globalFDR/04.group_glmnet_results.R

###################################################################################################
##Processing of the results of correlation_allmiRNAs_geneFPKM_withoutTranscription_svaadjusted.R##
###################################################################################################
#all_results = list()
...
#                                                        "/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/",
#                                                        "gene_expression_glmnet_alpha0.5_cond",condition,"_",part,".tsv", sep=""))
#  }
#}
#all_results = rbindlist(all_results)
#write.table(all_results, paste(EVO_IMMUNO_POP,
#                  "/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/",
#                  "gene_expression_glmnet_alpha0.5_allConds.tsv", sep=""), sep="\t", quote = F)
...
for (condition in 1:5){
  for (part in 0:99){
    ...
    all_results[[paste(condition, part,perm)]] = try(fread(paste(EVO_IMMUNO_POP,
                                                        "/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/perm",perm,"/gene_expression_glmnet_alpha0.5_cond",condition,"_",part,".tsv", sep="")))
...
##  write all results ##
########################
fwrite(all_results[probs_selection>.5,],file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/gene_expression_glmnet_alpha0.5_allConds_allQ_ProbOver0.5.tsv",EVO_IMMUNO_POP))
...
FDR_cutoff[,FDR_raw:= cummin(NbFP/NbTP),by=Q]
...
fwrite(FDR_cutoff,file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/FDR_cutoff.txt",EVO_IMMUNO_POP))
...
fwrite(FDR_pair,file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/FDR_pair.txt",EVO_IMMUNO_POP))
...
#  FDR for all Q, cutoffs and P-values
fwrite(FDR_cutoff_gene,file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/FDR_cutoff_gene.txt",EVO_IMMUNO_POP))
...
#  cutoffs and Nb of TP and FP ,for all Q :  at 1%, 5% and 10% FDR
fwrite(FDR_gene,file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/FDR_gene.txt",EVO_IMMUNO_POP))
...
fwrite(all_results[probs_selection>CutOff_max & Q==Qmax,],file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/gene_expression_glmnet_alpha0.5_allConds.tsv",EVO_IMMUNO_POP))

imax=FDR_pair[FDR_class=='<1%' ,which.max(NbTP)]
Qmax=FDR_pair[which(FDR_class=='<1%')[imax],Q]
CutOff_max=FDR_pair[which(FDR_class=='<1%')[imax],Cutoff]
fwrite(all_results[probs_selection>CutOff_max & Q==Qmax,],file=sprintf("%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_withoutTranscription_withoutSVA/gene_expression_glmnet_alpha0.5_allConds_1pct.tsv",EVO_IMMUNO_POP))
...
library(ggplot2)
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/FDR_pair.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
...
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/cutoff_pair.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
FDR_pair[,FDR:=factor(FDR_class,levels=c('<1%','<5%','<10%')),]
...
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/cutoff_pair_2.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
...
# plot Q vs TP, for various FDR thresholds
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/FDR_gene.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
...
# plot Q vs Cutoff, for various FDR thresholds
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/cutoff_gene.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
FDR_gene[,FDR:=factor(FDR_class,levels=c('<1%','<5%','<10%')),]
...
pdf(sprintf("%s/Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/variableQ_globalFDR/without_transcription_withoutSVA/cutoff_gene_2.pdf",EVO_IMMUNO_POP),height=2.5,width=5)
