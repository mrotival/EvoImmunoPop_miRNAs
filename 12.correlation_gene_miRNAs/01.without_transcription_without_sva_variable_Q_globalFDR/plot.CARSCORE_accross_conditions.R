...
all_CARSCORES = list()
for (cond in 1:5){
  all_CARSCORES[[cond]] = fread(paste(EVO_IMMUNO_POP, "/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variance_explained_by_miRNA_CARScore_withoutTranscription_withoutSVA/variance_explained_by_miRNA_CARScore_",cond,".tsv", sep=""))
}
...
colnames_to_delete = c(paste("miRNA_variance", 10, sep="_"),
                        paste("miRNA", 10, sep="_"),
                        paste("miRNA_carscore_sign", 10, sep="_"))
...
all_CARSCORES[, code_miRNA_9 := paste(gene, miRNA_9)]
...
all_CARSCORES[is.na(miRNA_carscore_sign_9), miRNA_carscore_sign_9 := 0]
...
all_CARSCORES[, variance_explained_by_negative_miRNA := ifelse(miRNA_carscore_sign_1 == -1, miRNA_variance_1, 0) +
                                                         ...
                                                         ifelse(miRNA_carscore_sign_9 == -1, miRNA_variance_9, 0)]
...
all_CARSCORES[, variance_explained_by_negative_miRNA_and_miRNABS := ifelse((miRNA_carscore_sign_1 == -1) & (code_miRNA_1 %in% miRNABS$code) , miRNA_variance_1, 0) +
                                                                    ...
                                                                    ifelse((miRNA_carscore_sign_9 == -1)& (code_miRNA_9 %in% miRNABS$code), miRNA_variance_9, 0)]
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "expression_variation_explaind_by_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "expression_variation_explaind_by_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "expression_variation_explaind_by_negative_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "expression_variation_explaind_by_negative_and_binding_miRNAs_only_genes_with_miRNA.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "percent_genes_regulated_by_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "percent_genes_regulated_by_negative_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
...
pdf(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/figures/12.correlation_gene_miRNAs/without_transcription_withoutSVA/", "percent_genes_regulated_by_negative_binding_miRNAs.pdf", sep=""), width = 4, height =4)
print(p)
dev.off()
