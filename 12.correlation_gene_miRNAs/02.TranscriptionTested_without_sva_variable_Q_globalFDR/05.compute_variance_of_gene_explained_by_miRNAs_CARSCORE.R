...
glmnet_data = fread(paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_transcriptionTested_withoutSVA/gene_expression_glmnet_alpha0.5_allConds.tsv", sep=""))
#glmnet_data = glmnet_data[selected_variables %in% c(miRNA_expression$miRNA,'gene_transcription')]
glmnet_data = glmnet_data[selected_variables %in% c(miRNA_expression$miRNA)]
...
outdir=paste(EVO_IMMUNO_POP, "Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/variance_explained_by_miRNA_CARScore_transcriptionTested_withoutSVA/",sep='')
dir.create(outdir)
