...
run_glmnet <- function(gene_name, PFER = 1, Q = Qlist, alpha = 0.5){
  print(gene_name)
...
dir.create(sprintf('%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_transcriptionTested_withoutSVA/',EVO_IMMUNO_POP))
dir.create(sprintf('%s/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_transcriptionTested_withoutSVA/perm%s/',EVO_IMMUNO_POP,perm))

write.table(results, paste(EVO_IMMUNO_POP, "/Maxime/miRNA_V2/data/12.correlation_gene_miRNAs/variableQ_globalFDR/glmnet_correlation_miRNA_geneRPKM_transcriptionTested_withoutSVA/perm",perm,"/gene_expression_glmnet_alpha0.5_cond", cond_to_investigate, "_", group_of_genes,".tsv", sep=""), sep="\t", quote=F , row.names = F)
print("done")
